...
public class ExtendoGripRenderHandler {
	...
	public static void tick() {
		...
		if (AllItems.EXTENDO_GRIP != player.getOffHandStack().getItem())
			return;
	...
	public static void onRenderPlayerHand(RenderHandEvent event) {
		...
		boolean notInOffhand = AllItems.EXTENDO_GRIP != offhandItem.getItem();
		if (notInOffhand && AllItems.EXTENDO_GRIP != heldItem.getItem())
			return;
