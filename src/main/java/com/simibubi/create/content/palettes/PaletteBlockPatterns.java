...
//	private IPatternBlockStateGenerator blockStateGenerator;
	private Function<FabricBlockSettings, ? extends Block> blockFactory;
//	private Function<PaletteStoneVariants, BiConsumer<DataGenContext<Block, ? extends Block>, RegistrateRecipeProvider>> additionalRecipes;
...
//		pattern.additionalRecipes = $ -> BiConsumer.noop();
...
//	}
	...
	public Function<FabricBlockSettings, ? extends Block> getBlockFactory() {
		return blockFactory;
	}
...
//	}
	...
	private PaletteBlockPatterns block(Function<FabricBlockSettings, ? extends Block> blockFactory) {
...
//		Function<PaletteStoneVariants, BiConsumer<DataGenContext<Block, ? extends Block>, RegistrateRecipeProvider>> func) {
...
//	}
	...
	protected Identifier toLocation(String variant, String texture) {
		return Create.id(String.format(textureLocation, variant, texture));
	}

	protected Identifier toOverlayLocation(String texture) {
		return Create.id(String.format(overlayLocation, texture));
	}
	...
	static interface IBlockStateProvider
		extends BiConsumer<DataGenContext<Block, ? extends Block>, RegistrateBlockstateProvider> {
	}*/
