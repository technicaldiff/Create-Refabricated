...
public class BeltMovementHandler {
	...
	public static void transportEntity(BeltBlockEntity beltTe, Entity entityIn, TransportedEntityInfo info) {
		...
		boolean collidedWithBelt = te instanceof BeltBlockEntity;
		boolean betweenBelts = tileEntityBelowPassenger instanceof BeltBlockEntity && tileEntityBelowPassenger != te;
		...
		boolean movedPastEndingSlope = onSlope && (world.getBlockState(entityIn.getBlockPos()).getBlock() == AllBlocks.BELT
			|| (world.getBlockState(entityIn.getBlockPos().down())).getBlock() == AllBlocks.BELT);
