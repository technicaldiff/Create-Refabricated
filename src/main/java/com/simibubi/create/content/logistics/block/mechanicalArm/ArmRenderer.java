...
public class ArmRenderer extends KineticBlockEntityRenderer {
	...
	@Override
	public boolean rendersOutsideBoundingBox(KineticBlockEntity te) {
		return true;
	}

	@Override
	protected void renderSafe(KineticBlockEntity te, float pt, MatrixStack ms, VertexConsumerProvider buffer, int light,
		int overlay) {
