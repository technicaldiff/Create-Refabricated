...
public class NixieTubeBlockEntity extends SmartBlockEntity {
	...
	public NixieTubeBlockEntity(BlockEntityType<?> tileEntityTypeIn) {
		super(tileEntityTypeIn);
		redstoneStrength = 0;
		customText = Optional.empty();
	}

	public NixieTubeBlockEntity() {
		super(AllBlockEntities.NIXIE_TUBE);
		redstoneStrength = 0;
		customText = Optional.empty();
	}
	...
	@Override
	protected void toTag(CompoundTag nbt, boolean clientPacket) {
		super.toTag(nbt, clientPacket);
