...
public class NixieTubeRenderer extends SafeBlockEntityRenderer<NixieTubeBlockEntity> {
	...
	@Override
	protected void renderSafe(NixieTubeBlockEntity te, float partialTicks, MatrixStack ms, VertexConsumerProvider buffer,
	...
	/* doesnt seem to be needed, avoiding adding another accessor -smellypengu
	private static float getCharWidth(char p_211125_1_, TextRenderer fontRenderer) {
		return p_211125_1_ == 167 ? 0.0F : ((TextRendererAccessor) fontRenderer).getFontStorage(Style.DEFAULT_FONT_ID).getGlyph(p_211125_1_).getAdvance(false);
	}*/
}
